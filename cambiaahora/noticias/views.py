...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if cur_language == 'en':
            ...
            context['audios'] = Audios.objects.filter(aprobacion=2,idioma=2).order_by('-titulo')[:3]
            ...
            context['audios'] = Audios.objects.filter(aprobacion=2,idioma=1).order_by('-titulo')[:3]
