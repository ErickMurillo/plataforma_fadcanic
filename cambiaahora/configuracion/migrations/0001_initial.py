    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion1', models.CharField(max_length=450, null=True, verbose_name='Descripci\xf3n espa\xf1ol')),
                ('titulo2', models.CharField(max_length=250, verbose_name='Titulo ingles')),
                ('descripcion2', models.CharField(max_length=450, null=True, verbose_name='Descripci\xf3n ingles')),
                ('titulo3', models.CharField(max_length=250, verbose_name='Titulo miskitu')),
                ('descripcion3', models.CharField(max_length=450, null=True, verbose_name='Descripci\xf3n miskitu')),
                ('titulo4', models.CharField(max_length=250, verbose_name='Titulo otro')),
                ('descripcion4', models.CharField(max_length=450, null=True, verbose_name='Descripci\xf3n otro')),
