...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('pregunta14', models.IntegerField(verbose_name=b'14 -\xc2\xbfC\xc3\xb3mo valora la situaci\xc3\xb3n de la violencia juvenil y abuso de drogas en su localidad?', choices=[(1, b'Alta'), (2, b'Media'), (3, b'Baja'), (4, b'No responde'), (5, b'No sabe')])),
                ('pregunta15', models.IntegerField(verbose_name=b'15- \xc2\xbfQu\xc3\xa9 piensa usted de las personas violentas y abusadores de droga?', choices=[(1, b'Son enfermos'), (2, b'Criminales/delincuentes'), (3, b'Personas que se equivocan'), (4, b'No cuentan con la educaci\xc3\xb3n suficiente'), (5, b'Fueron v\xc3\xadctimas de violencia'), (6, b'Personas violentas de acuerdo a su Etnia'), (7, b'No responde'), (8, b'No sabe')])),
                ('pregunta16', models.IntegerField(verbose_name=b'16- \xc2\xbfQu\xc3\xa9 piensa de las personas v\xc3\xadctimas de la violencia juvenil?', choices=[(1, b'Hay que brindarles ayuda'), (2, b'Es pasajero, no lo necesita'), (3, b'El/ella se lo busco'), (4, b'No responde'), (5, b'No sabe')])),
                ('pregunta17', models.IntegerField(verbose_name=b'17- \xc2\xbfC\xc3\xb3mo prevenir la violencia juvenil y abuso de drogas?', choices=[(1, b'Mayor orientaci\xc3\xb3n de la familia'), (2, b'Organizando a la comunidad'), (3, b'Mayores niveles de informaci\xc3\xb3n'), (4, b'Acceso a la educaci\xc3\xb3n'), (5, b'Generando oportunidades de empleo'), (6, b'No responde'), (7, b'No sabe')])),
                ('pregunta18', models.IntegerField(verbose_name=b'18- \xc2\xbfCu\xc3\xa1les cree usted son las principales causas de la violencia juvenil?', choices=[(1, b'Falta de informaci\xc3\xb3n'), (2, b'Maltrato f\xc3\xadsico en el seno familiar'), (3, b'Carencia afectiva de la familia'), (4, b'Desintegraci\xc3\xb3n de la familia'), (5, b'Por el grupo \xc3\xa9tnico al que pertenece'), (6, b'Viene en la sangre (genes)'), (7, b'No sabe')])),
                ('pregunta19', models.IntegerField(verbose_name=b'19- \xc2\xbfPor qu\xc3\xa9 crees que muchas mujeres despu\xc3\xa9s vivir violencia, perdonan a sus parejas o abusadores?', choices=[(1, b'Masoquismo'), (2, b'Porque le ama y cree que puede cambiar'), (3, b'No cuenta con apoyo para mantenerse'), (4, b'No recibi\xc3\xb3 apoyo de las instituciones'), (5, b'No responde'), (6, b'No sabe')])),
                ('pregunta20', models.IntegerField(verbose_name=b'20- \xc2\xbfCu\xc3\xa1les cree Usted son las causas de abuso sexual?', choices=[(1, b'Falta de educaci\xc3\xb3n'), (2, b'Falta de informaci\xc3\xb3n'), (3, b'La no protecci\xc3\xb3n de los padres a sus hijos/hijas'), (4, b'Falta de vigilancia policial en la ciudad'), (5, b'La comunidad sabe pero no denuncia'), (6, b'Por abuso de droga y alcohol'), (7, b'No responde'), (8, b'No sabe')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pregunta44', models.IntegerField(verbose_name=b'44- \xc2\xbfUsted sabe qu\xc3\xa9 tipo de atenci\xc3\xb3n brindan en esos lugares?', choices=[(1, b'Atenci\xc3\xb3n psicol\xc3\xb3gica'), (2, b'Atenci\xc3\xb3n Jur\xc3\xaddica'), (3, b'Atenci\xc3\xb3n m\xc3\xa9dica'), (4, b'Acompa\xc3\xb1amiento de los casos'), (5, b'Desconoce')])),
                ('pregunta45', models.IntegerField(verbose_name=b'45- \xc2\xbfSi no hay ning\xc3\xban lugar en su comunidad donde se atiende a las personas v\xc3\xadctimas violencia juvenil y abuso de drogas a d\xc3\xb3nde van para recibir atenci\xc3\xb3n?', choices=[(1, b'Viaja a otro municipio/comunidad'), (2, b'Paga psic\xc3\xb3loga o abogados particulares'), (3, b'No hace nada'), (4, b'No sabe')])),
                ('encuesta', models.ForeignKey(to='violencia_juvenil.Encuesta')),
                ('si_respuesta_42', models.ForeignKey(verbose_name=b'Si responde Si, favor mencione tipos de acci\xc3\xb3n', blank=True, to='violencia_juvenil.Acciones', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('pregunta25', models.IntegerField(verbose_name=b'25-\xc2\xbfQui\xc3\xa9nes son los m\xc3\xa1s afectados por la violencia?', choices=[(1, b'Ni\xc3\xb1as, ni\xc3\xb1os'), (2, b'J\xc3\xb3venes (mujeres y hombres)'), (3, b'Mujeres'), (4, b'La familia'), (5, b'La persona violenta'), (6, b'La comunidad'), (7, b'El pa\xc3\xads')])),
                ('pregunta26', models.IntegerField(verbose_name=b'26- \xc2\xbfQui\xc3\xa9nes deben ser protagonistas de la prevenci\xc3\xb3n de la violencia juvenil y abuso de drogas?', choices=[(1, b'La familia'), (2, b'La Comunidad'), (3, b'El Estado'), (4, b'La Polic\xc3\xada'), (5, b'Medios de Comunicaci\xc3\xb3n'), (6, b'Gobiernos Aut\xc3\xb3nomos'), (7, b'Las Iglesias'), (8, b'ONGs')])),
                ('pregunta27', models.IntegerField(verbose_name=b'27- \xc2\xbfEn que familias se da m\xc3\xa1s frecuentemente el abuso sexual?', choices=[(1, b'Familias pobres'), (2, b'Familias de clase media'), (3, b'Familias adineradas'), (4, b'Todas por igual')])),
                ('pregunta28', models.IntegerField(verbose_name=b'28- \xc2\xbfQu\xc3\xa9 piensa del rol de las autoridades en la prevenci\xc3\xb3n de la violencia juvenil y abuso de drogas?', choices=[(1, b'Educan a la poblaci\xc3\xb3n'), (2, b'Dan seguimiento a los casos'), (3, b'Revictimizan a las victimas'), (4, b'Brindan asistencia psicol\xc3\xb3gica a la v\xc3\xadctimas'), (5, b'No hacen nada')])),
                ('pregunta29', models.IntegerField(verbose_name=b'29- \xc2\xbfPor qu\xc3\xa9 los j\xc3\xb3venes que consumen droga se vuelven adictos?', choices=[(1, b'Porque no reciben tratamientos especializado'), (2, b'Faltan centros especializados'), (3, b'No reciben el apoyo de sus familias'), (4, b'Los marginans'), (5, b'La polic\xc3\xada no actu\xc3\xa1 para apresarlos'), (6, b'Baja autoestima')])),
                ('pregunta30', models.IntegerField(verbose_name=b'30- \xc2\xbfPara usted que acciones se puede hacer desde la comunidad para la prevenci\xc3\xb3n de la violencia juvenil y abuso de drogas?', choices=[(1, b'Denunciar a las autoridades'), (2, b'Organizar promotores para la prevenci\xc3\xb3n'), (3, b'Campa\xc3\xb1as p\xc3\xbablicas abordando el tema'), (4, b'Campa\xc3\xb1as de informaci\xc3\xb3n en escuelas')])),
                ...
                ('pregunta32', models.IntegerField(verbose_name=b'32- \xc2\xbfQu\xc3\xa9 piensa del rol de las autoridades en la prevenci\xc3\xb3n de la violencia juvenil y abuso de drogas?', choices=[(1, b'Educan a la poblaci\xc3\xb3n'), (2, b'Dan seguimiento a los casos'), (3, b'Revictimizan a las victimas'), (4, b'Brindan asistencia psicol\xc3\xb3gica a la v\xc3\xadctimas'), (5, b'No hacen nada')])),
                ...
                ('pregunta34', models.IntegerField(verbose_name=b'34- \xc2\xbfQui\xc3\xa9nes consideras que son m\xc3\xa1s violentos?', choices=[(1, b'Varones adultos'), (2, b'Mujeres adultas'), (3, b'Varones j\xc3\xb3venes'), (4, b'Mujeres j\xc3\xb3venes'), (5, b'Varones adolescentes'), (6, b'Mujeres adolescentes')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('pregunta21', models.IntegerField(verbose_name=b'21- \xc2\xbfQu\xc3\xa9 har\xc3\xadas si en tu presencia alguien es v\xc3\xadctimade violencia juvenil?', choices=[(1, b'La defiendo, ejerciendo la fuerza'), (2, b'No hago nada'), (3, b'Hago denuncia a las autoridades'), (4, b'Lo denuncio con un familiar de la v\xc3\xadctima'), (5, b'No responde'), (6, b'No sabe')])),
                ('pregunta22', models.IntegerField(verbose_name=b'22- \xc2\xbfQu\xc3\xa9 hace usted para prevenir la violencia juvenil y abuso de droga?', choices=[(1, b'Participo de actividades de prevenci\xc3\xb3n en mi lugar'), (2, b'Trato de informarme'), (3, b'Evito discusi\xc3\xb3n o acciones que gener\xc3\xa9 violencia'), (4, b'Protejo a mi familia'), (5, b'Hago denuncia p\xc3\xbablica'), (6, b'No hago nada'), (7, b'No s\xc3\xa9 que hacer')])),
                ('pregunta23', models.IntegerField(verbose_name=b'23- \xc2\xbfQu\xc3\xa9 har\xc3\xadas si en tu presencia una mujer es v\xc3\xadctima de violencia?', choices=[(1, b'La defender\xc3\xada'), (2, b'Poner denuncia ante la Polic\xc3\xada'), (3, b'No hago nada'), (4, b'Me alejo del problema'), (5, b'No responde')])),
                ('pregunta24', models.IntegerField(verbose_name=b'24- \xc2\xbfQu\xc3\xa9 hacer para que los j\xc3\xb3venes no caigan en el problema de narcotr\xc3\xa1fico?', choices=[(1, b'Mayor vigilancia policial'), (2, b'Generar oportunidades de empleo'), (3, b'Mayor acceso a la educaci\xc3\xb3n'), (4, b'Un sistema de justicia m\xc3\xa1s beligerante'), (5, b'Mayor uni\xc3\xb3n familiar'), (6, b'Mayor organizaci\xc3\xb3n de la comunidad'), (7, b'No responde'), (8, b'No sabe')])),
                ('encuesta', models.ForeignKey(to='violencia_juvenil.Encuesta')),
            ],
            options={
